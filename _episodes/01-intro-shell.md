...
There have been many shells over the years, and many shells may exist on any given computer. Probably one of the first shells was simply called "sh". Later, a shell called "csh" was developed and considered both more functional and more expressive. For quite a number of years now, the shell named "bash" is/was popular. As alluded to above, all shells have more things in common than differences; they all enable the user to create, edit, and manage files, navigate the file system (hard drive), start and stop processes (programs), and interact with networked devices. 
...
The shell is one of the most productive programming environments ever created. Once mastered, you can use it to experiment with different commands interactively, then use what you have learned to automate your work. Once mastered, you can unequivocally say you control your computer as opposed to the other way around. For example, just last week, with only three for four well-articulated commands I was able to compress, copy, uncompress, and rename hundreds of directories. I was then able to generate hundreds of well-formed and valid RDF/XML files while putting then on the Web for the purposes of practicing Linked Data.
