...
As a librarian in Data Services, I use the shell all of the time to check large files, assess the status of a bunch of files in a directory, avoid having to use Microsoft Excel, and many more reasons.
